...
class UpsYd{
    ...
    function __construct($userId, $password, $accessLicenseNumber, $shipperNumber, $endpoint="live"){
        $this->userId = $userId;
    ...
    public function createShipment($data){
        $response = $this->shipConfirm($data);
    ...
    public function shipConfirm($data){
        $data['shipToCountryCode'] = explode('-',$data['shipToCountryCode']);
        $data['shipToCountryCode'] = trim($data['shipToCountryCode'][0]);
        list($shipperAddress1, $shipperAddress2, $shipperAddress3) = $this->smashAddress($data['shipperAddress']);
        list($shipToAddress1, $shipToAddress2, $shipToAddress3) = $this->smashAddress($data['shipToAddress']);
        try {
            // Create AccessRequest XMl
            $accessRequestXML = new SimpleXMLElement ("<AccessRequest></AccessRequest>");
            $accessRequestXML->addChild ("AccessLicenseNumber", $this->accessLicenseNumber);
            ...
            $shipper->addChild ("Name", $data['shipperFullName']);
            $shipper->addChild ("AttentionName", $data['shipperFullName']);
            $shipper->addChild ("PhoneNumber", $data['shipperPhone']);
            $shipper->addChild ("TaxIdentificationNumber", $data['shipperPhone']);
            ...
            $shipperAddress->addChild ("City", $data['shipperCityName']);
            ...
            $shipFrom->addChild ("PhoneNumber", $data['shipperPhone']);
            $shipFrom->addChild ("TaxIdentificationNumber", $data['shipperPhone']);
            ...
            $shipFromAddress->addChild ("City", $data['shipperCityName']);
            ...
            $shipTo->addChild ("CompanyName", $data['shipToFullName']);
            $shipTo->addChild ("AttentionName", $data['shipToFullName']);
            $shipTo->addChild ("PhoneNumber", $data['shipToPhone']);
            ...
            $shipToAddress->addChild ("City", $data['shipToCityName']);
            $shipToAddress->addChild ("StateProvinceCode", $data['shipToCountryCode']);
            $shipToAddress->addChild ("PostalCode", $data['shipToPostalCode']);
            $shipToAddress->addChild ("CountryCode", $data['shipToCountryCode']);
